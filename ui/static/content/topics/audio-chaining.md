...
> ✨ [Try this patch](/?demo=fm-synth) — FM synthesis using oscillators, expressions, gain control, and frequency analysis.
...
[This patch](/?demo=upbeat-expressions) by [@kijjaz](https://www.instagram.com/kijjaz) creates a beat with mathematical expressions:

![Beat example](/content/images/patchies-audio-super-fun.png)

Build a drum machine with [this patch](/?demo=drum-machine). Use `W A S D` to play drums:
