...
> Try this patch [in the app](/?src=/demos/irc-chat-simulator.json)!
...
See the [P2P Messaging docs](/docs/network-p2p) for the room configuration, how it works and the Node.js/Bun integration.
