...
For sample-accurate triggering from `sequencer` with **single outlet midi** and
**Audio lookahead** enabled, `pads~` also accepts absolute Web Audio times:
...
playback and gated releases on the audio clock.
