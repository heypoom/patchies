...
import { Collapse, Expand, Run, SetCode } from '$lib/objects/schemas/common';
  ...
  inlets: [
    {
      ...
      messages: [
        ...
        { schema: Expand, description: 'Enter fullscreen surface mode' },
        { schema: Collapse, description: 'Exit fullscreen surface mode' },
