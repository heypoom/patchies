<script lang="ts">
  ...
  import { asmMessages } from '$objects/asm/asm.schema';
  import { AssemblySystem } from '$objects/asm/AssemblySystem';
  import AssemblyEditor from '$objects/asm/AssemblyEditor.svelte';
  import MachineStateViewer from '$objects/asm/MachineStateViewer.svelte';
  import type { InspectedMachine, Message, MachineConfig } from '$objects/asm/AssemblySystem';
  import { memoryActions } from '$objects/asm/memoryStore';
  import { formatSequencerError } from '$objects/asm/formatSequencerError';
  import {
  ...
  import PaginatedMemoryViewer from '$objects/asm/PaginatedMemoryViewer.svelte';
  ...
  const toggleMemoryViewer = () =>
    updateData<{ showMemoryViewer?: boolean }>(nodeId, (data) => ({
      showMemoryViewer: !data.showMemoryViewer
    }));
