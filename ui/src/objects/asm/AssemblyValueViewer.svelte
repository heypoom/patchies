<script lang="ts">
  ...
  import { regionPalettes, getRegionClassName } from '$objects/asm/regionColors';
  import { ASM_VALUE_VIEWER_UPDATE_INTERVAL } from '$objects/asm/constants';
...
<div class="relative flex gap-x-3">
  <div class="group relative">
    ...
    <div class="absolute -top-7 left-0 flex w-full items-center justify-between">
      ...
      <button
        class="z-4 rounded p-1 opacity-0 transition-opacity group-hover:opacity-100 hover:bg-zinc-700"
