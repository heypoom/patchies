const BUMP_STREET = `// froos - "22 bump street", licensed with CC BY-NC-SA 4.0
...
const TRAFFIC_FLAM = `// froos - "traffic flam", licensed with CC BY-NC-SA 4.0
...
const FUNK_42 = `// froos - how to funk in 42 lines of code
