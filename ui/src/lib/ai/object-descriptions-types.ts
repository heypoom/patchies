...
- datatable: Editable CSV-style data table that outputs a 2D array by default
...
- datatable: Editable CSV-style data table; bang outputs a 2D array with headers first, optional row-object output
