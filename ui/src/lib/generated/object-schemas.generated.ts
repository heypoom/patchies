 ...
 *
 * Contains schemas for 165 object types (audio + control).
 */
...
export const generatedObjectSchemas: ObjectSchemaRegistry = {
  ...
  pd: {
    type: 'pd',
    category: 'audio',
    description: 'Load and run a Pure Data patch',
    inlets: [
      {
        id: 'in',
        type: 'signal',
        ...
        messages: [
          {
            ...
            description: 'Send a value to a Pd receiver'
          },
          {
            schema: Type.Object({ type: Type.Literal('load'), src: Type.String() }),
            description: 'Load a Pd patch from a VFS path or URL'
          },
          {
            schema: Type.Object({ type: Type.Literal('load'), code: Type.String() }),
            description: 'Load Pd patch source code'
          }
        ],
        handle: { handleType: 'message', handleId: 1 }
      }
    ...
    outlets: [
      ...
      },
      {
        id: 'message',
        type: 'message',
        description: 'Messages from exposed Pd senders',
        handle: { handleType: 'message', handleId: 1 }
      }
    ],
    tags: ['audio', 'pure data', 'pd', 'cyclone', 'else', 'experimental']
  },
