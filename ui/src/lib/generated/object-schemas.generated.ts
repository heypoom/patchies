    ...
    inlets: [
      {
        ...
        messages: [
          { schema: Type.Number(), description: 'Evaluate the function at X, output Y' },
          {
            schema: Type.Object({ type: Type.Literal('bang') }),
            description: 'Output the full breakpoint list as [x1, y1, x2, y2, ...]'
          },
          {
            schema: Type.Array(Type.Number(), { minItems: 4 }),
          ...
          },
          {
            ...
            description: 'Reset to default: flat line at y=0.5'
          }
        ],
        handle: { handleType: 'message' }
      }
    ...
    outlets: [
      {
        ...
        messages: [
          { schema: Type.Number(), description: 'Interpolated Y value at the given X' },
          {
            schema: Type.Array(Type.Number(), { minItems: 4 }),
    ...
    inlets: [
      {
        ...
        messages: [
          ...
          {
            schema: Type.Object({ type: Type.Literal('set'), value: Type.Any() }),
            description: 'Set message without triggering output'
          },
          {
            schema: Type.Any(),
