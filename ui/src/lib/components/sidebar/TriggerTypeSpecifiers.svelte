<script lang="ts">
  import { TRIGGER_TYPE_SPECS } from '$objects/trigger/trigger-type-specs';
</script>

<div class="mb-4">
  <h3 class="mb-2 text-xs font-medium tracking-wider text-zinc-500 uppercase">Type Specifiers</h3>
