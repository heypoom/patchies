...
<div class="relative flex gap-x-3">
	<div class="group relative">
		<div class="flex flex-col gap-2">
			...
			<div class="relative">
				<StandardHandle port="inlet" type="message" title="Control Input" total={1} index={0} />
				...
				<StandardHandle port="outlet" type="message" title="MIDI Output" total={1} index={0} />
			</div>
		</div>
	</div>
