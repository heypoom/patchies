...
// https://github.com/google/swissgl/blob/main/LICENSE
...
// See the License [https://github.com/google/swissgl/blob/main/LICENSE] for the specific language governing permissions and limitations under the License.
...
class TextureTarget extends TextureSampler {
  constructor(gl, params) {
    ...
    const typePrefix = format.endsWith('u') ? 'u' : format.endsWith('i') ? 'i' : '';
