...
export type RuntimeError = { type: "StackUnderflow"; top: number; min: number } | { type: "StackOverflow"; top: number; max: number } | { type: "CallStackExceeded" } | { type: "MissingReturnAddress" } | { type: "MissingMessageBody" } | { type: "CannotReadStringFromBytes" } | { type: "CannotLoadFromMemory" } | { type: "CannotDivideByZero" } | { type: "IntegerOverflow" } | { type: "IntegerUnderflow" } | { type: "MissingValueToStore" } | { type: "NotEnoughValues"; min: number; len: number } | { type: "IndexOutOfBounds"; index: number; len: number };
...
export type Action = { type: "Data"; body: number[] } | { type: "Read"; address: number; count: number } | { type: "Write"; address: number; data: number[] } | { type: "Override"; data: number[] };
...
export type ParseError = { type: "InvalidString" } | { type: "UndefinedSymbols" } | { type: "InvalidIdentifier" } | { type: "UndefinedInstruction"; name: string } | { type: "InvalidLabelDescription" } | { type: "DuplicateLabelDefinition" } | { type: "DuplicateStringDefinition" } | { type: "DuplicateSymbolDefinition" } | { type: "InvalidArgument"; errors: ParseError[] } | { type: "InvalidStringValue" } | { type: "InvalidByteValue" } | { type: "InvalidArgToken" } | { type: "CannotPeekAtToken" } | { type: "PeekExceedsSourceLength" } | { type: "InvalidDecimalDigit"; text: string } | { type: "InvalidHexDigit"; text: string } | { type: "ScannerReachedEndOfLine" } | { type: "EmptyProgram" };

export type MachineStatus = "Invalid" | "Loaded" | "Ready" | "Running" | "Awaiting" | "Sleeping" | "Halted" | "Errored";
...
declare namespace CanvasError {
    ...
    export type CannotFindWire = { type: "CannotFindWire"; src: __CanvasErrorPort; dst: __CanvasErrorPort };
    export type BlockIdInUse = { type: "BlockIdInUse"; id: number };
    export type MissingMessageRecipient = { type: "MissingMessageRecipient"; message: __CanvasErrorMessage };
}

export type CanvasError = { type: "CannotWireToItself"; port: Port } | { type: "BlockNotFound"; id: number } | { type: "MachineNotFound"; id: number } | { type: "MachineError"; cause: SequencerError } | { type: "DisconnectedPort"; port: Port } | { type: "CannotFindWire"; src: Port; dst: Port } | { type: "BlockIdInUse"; id: number } | { type: "MissingMessageRecipient"; message: Message };
...
declare namespace SequencerError {
    ...
    export type ExecutionFailed = { type: "ExecutionFailed"; id: number; error: __SequencerErrorRuntimeError };
...
export type SequencerError = { type: "CannotParse"; id: number; error: ParseError } | { type: "ExecutionFailed"; id: number; error: RuntimeError } | { type: "MachineDoesNotExist"; id: number } | { type: "ReceiveFailed"; error: RuntimeError } | { type: "MessageNeverReceived"; id: number } | { type: "ExecutionCycleExceeded"; id: number };
