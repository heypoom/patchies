...
pub enum Op {
    ...
    /// Pop the sleep duration from the stack and sleep for that amount of milliseconds
    SleepMs,

    /// Pop the sleep duration from the stack and sleep for that amount of ticks
    SleepTick,
