...
> This feature is only available in `js`, `p5`, `canvas`, `canvas.dom`, `textmode`, `textmode.dom`, `three`, `three.dom`, `hydra`, `sonic~` and `elem~` objects.
...
> This feature is available in `js`, `p5`, `canvas`, `canvas.dom`, `textmode`, `textmode.dom`, `three`, `three.dom`, `hydra`, `sonic~`, and `elem~` objects.
