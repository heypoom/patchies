...
- Compute like an ancient witch with [Stack Machine Assembly](https://patchies.app/docs/objects/asm) and [Uiua](https://patchies.app/docs/objects/uiua), or like a wizard with [Ruby](https://patchies.app/docs/objects/ruby) and [Python](https://patchies.app/docs/objects/python)
