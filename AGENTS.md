...
- In multiline code, use blank lines to separate setup, configuration, side effects, and return values. Format chained calls one method per line when they make the setup easier to scan.
