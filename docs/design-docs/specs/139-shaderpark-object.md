...
- Completions sourced from `shader-park-core` internals should still describe the actual shape and arguments instead of exposing implementation placeholders.
