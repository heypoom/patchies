...
- [77. Global Transport Control](/docs/design-docs/specs/78-global-transport-control.md)
- [80. Clock Scheduling API](/docs/design-docs/specs/81-clock-scheduling-api.md)
