# 92. Sample Search Sidebar Panel
...
- **Freesound provider**: API-based search with OAuth. Requires API key settings UI (could use the dynamic settings API from spec 91).
